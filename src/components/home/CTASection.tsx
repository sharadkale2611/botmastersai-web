  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 rounded-[2rem] border border-white/15 bg-white/[0.07] p-6 shadow-2xl shadow-black/20 backdrop-blur md:grid-cols-[0.75fr_1.25fr] sm:p-10 lg:p-12">
        {/* Left Card */}
        <div className="mx-auto w-full max-w-sm rounded-3xl border border-white/10 bg-white/10 p-8 shadow-xl shadow-black/20 backdrop-blur md:mx-0">
          ...
          <div className="mt-8 border-t border-white/10 pt-6">
            <p className="text-sm text-blue-100/80">
              Students • Freshers • Professionals
            </p>
          </div>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-5 max-w-2xl text-pretty text-lg leading-8 text-blue-100/80 md:mx-0">
            Join BotMasters AI and gain practical experience with Full Stack
            Development, AI integrations, code reviews, and real-world projects.
          </p>
